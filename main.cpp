...
int main(int argc, char* argv[]) {
  ...
  // write output PNG
  string outfilename = "images-output/kkkk_nnkm-render_x1.png";
...
void TestBuildRender(unsigned int scale) {
  ...
  // write output PNG
  string outfilename
      = "images-output/malachi-render_x" + to_string(scale) + ".png";
  cout << "Writing rendered PNG to file... ";
  output.writeToFile(outfilename);
  cout << "done." << endl;
...
void TestPrune(double tol) {
  ...
  cout << "Tree contains " << t.CountNodes() << " nodes and " << t.CountLeaves()
       << " leaves." << endl;
  ...
  cout << "Pruned tree contains " << t.CountNodes() << " nodes and "
       << t.CountLeaves() << " leaves." << endl;
  ...
  // write output PNG
  string outfilename = "images-output/kkkk_nnkm-256x224-prune_" + to_string(tol)
                       + "-render_x1.png";
  cout << "Writing rendered PNG to file... ";
  output.writeToFile(outfilename);
  cout << "done." << endl;
